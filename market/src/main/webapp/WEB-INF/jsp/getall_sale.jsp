...
<%-- 			                              <button class="btn btn-primary" type="button">查询</button>
			                              <button class="btn btn-primary"  type="button" href="${pageContext.request.contextPath }/staff/flatform/sale/toaddpro">新增</button>
					        ...
					        <c:forEach items="${pageInfo.list}" var="sale">
					        	<tr>
					                         ...
					                         <th>
					                            ...
					                            <a href="${pageContext.request.contextPath }/staff/flatform/sale/delete?saleid=${sale.saleid}"  class="btn btn-danger btn-xs" aria-label="Left Align" role="button">删除</a>
					                         </th>
					          	</tr>
					         </c:forEach>
	                    </table>
