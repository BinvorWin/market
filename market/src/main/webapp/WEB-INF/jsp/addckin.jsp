...
<%@include file="common/head.jsp"%>
	...
	<form class="form-horizontal form-label-left" method="post" action="insert">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                          <input id="proid" name="proid" class="form-control input-small input-sm "  value="${ckin.proid}"  type="text" >
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-5">
                          <input id="pname" name="pname" class="form-control col-md-7 col-xs-5" value="${ckin.pname}"  type="text" >
                        </div>
                      </div>
                      <div class="item form-group">
