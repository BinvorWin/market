...
<%@include file="common/head.jsp"%>
	...
	<form class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
						...
						<a href="${pageContext.request.contextPath }/staff/flatform/product/editpro?proid=${product.proid}" class=" text-center btn btn-primary  col-md-offset-4 col-lg-offset-4col-xl-offset-4" role="button">修改</a>
