    ...
    <form class="form-horizontal form-label-left" method="post" action="insert" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="inid" name="inid" class="form-control input-small input-sm " value="${ckin.inid}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="proid" name="proid" class="form-control input-small input-sm " value="${ckin.proid}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pname" name="pname" class="form-control col-md-7 col-xs-5" value="${ckin.pname}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="num" name="num" class="form-control col-md-7 col-xs-5" value="${ckin.num}" type="text"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="indate" name="indate" class="form-control col-md-7 col-xs-5"
                       value="<fmt:formatDate pattern="yyyy-MM-dd" value="${ckin.indate}"/>" type="date">
            </div>
        </div>
        <div class="item form-group">
        ...
        <a href="${pageContext.request.contextPath }/manager/flatform/ckin/getall" class=" text-left btn btn-default"
           role="button">返回上页</a>
