    ...
    <form class="form-horizontal form-label-left" method="post" action="insert" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="supid" name="supid" class="form-control col-md-7 col-xs-5" value="${supply.supid}"
                       type="text" onblur="checkid()"><span id="demo1" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="suppname" name="suppname" class="form-control col-md-7 col-xs-5" value="${supply.suppname}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="person" name="person" class="form-control col-md-7 col-xs-5" value="${supply.person}"
                       type="text">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="address" name="address" class="form-control col-md-7 col-xs-5" value="${supply.address}"
                       type="text">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="emali" name="emali" class="form-control col-md-7 col-xs-5" value="${supply.emali}"
        ...
        <button type="submit" class="btn btn-primary text-center  col-md-offset-4 col-lg-offset-4 col-xl-offset-4">增加
        </button>
