            ...
            <div class="row">
                <form class="form-inline" action="getprobyparams" method="post">
                    ...
                    <span class="row">
								  ...
								  <a href="${pageContext.request.contextPath }/manager/flatform/product/toaddpro"
                                ...
                                <th>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="${pageContext.request.contextPath }/manager/flatform/product/getpro?proid=${product.proid}">查看</a>
                                            </li>
                                            <li>
                                                <a href="${pageContext.request.contextPath }/manager/flatform/product/editpro?proid=${product.proid}">修改</a>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath }/manager/flatform/product/getlist?pn=1">首页</a>
                            </li>
                            <c:if test="${pageInfo.hasPreviousPage }">
                                <li>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/product/getlist?pn=${pageInfo.pageNum-1}"
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                ...
                                <c:if test="${page_Num != pageInfo.pageNum }">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/manager/flatform/product/getlist?pn=${page_Num }">${page_Num }</a>
                                    </li>
                                </c:if>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath }/manager/flatform/product/getlist?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
