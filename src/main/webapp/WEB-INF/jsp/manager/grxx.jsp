    ...
    <form class="form-horizontal form-label-left" novalidate>
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="managerid" class="form-control input-small input-sm " value="${manager.managerid}"
                       type="text" readonly>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="managername" class="form-control col-md-7 col-xs-5" value="${manager.managername}"
                       type="text" readonly>
            </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="stafftype" class="form-control col-md-7 col-xs-5" value="${manager.stafftype}" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
        ...
        <a href="${pageContext.request.contextPath }/manager/toupdate?managerid=${manager.managerid}"
