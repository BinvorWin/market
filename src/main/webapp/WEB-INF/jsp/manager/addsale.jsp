    ...
    <form class="form-horizontal form-label-left" method="post" action="insert" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="saleid" name="saleid" class="form-control input-small input-sm " value="${sale.saleid}"
                       type="text" onblur="checksaleid()"><span id="demo1" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="proid" name="proid" class="form-control input-small input-sm " value="${sale.proid}"
                       type="text" onblur="checkproid()"><span id="demo2" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pname" name="pname" class="form-control col-md-7 col-xs-5" value="${sale.pname}" type="text"
                       onblur="checkproname()" readonly><span id="demo3" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="price" name="price" class="form-control col-md-7 col-xs-5" value="${sale.price}"
                       type="number" onblur="checkprice()" readonly><span id="demo4" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="num" name="num" class="form-control col-md-7 col-xs-5" value="${sale.num}" type="number"
                       onblur="checknum()"><span id="demo5" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="cusid" name="cusid" class="form-control input-small input-sm " value="${sale.cusid}"
                       type="text" onblur="checkcusid()"><span id="demo6" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="cusname" name="cusname" class="form-control col-md-7 col-xs-5" value="${sale.cusname}"
                       type="text" onblur="checkcusname()"><span id="demo7" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
