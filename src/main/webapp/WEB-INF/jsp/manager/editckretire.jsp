    ...
    <form class="form-horizontal form-label-left" method="post" action="update" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="inid" name="inid" class="form-control input-small input-sm " value="${ckretire.inid}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="proid" name="proid" class="form-control input-small input-sm " value="${ckretire.proid}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pname" name="pname" class="form-control col-md-7 col-xs-5" value="${ckretire.pname}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="retdate" name="retdate" class="form-control col-md-7 col-xs-5"
                       value="<fmt:formatDate pattern="yyyy-MM-dd" value="${ckretire.retdate}"/>" type="date">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="marks" name="marks" class="form-control col-md-7 col-xs-5" value="${ckretire.marks}"
                       type="text">
            </div>
        </div>
        <a href="${pageContext.request.contextPath }/manager/flatform/ckretire/getall"
