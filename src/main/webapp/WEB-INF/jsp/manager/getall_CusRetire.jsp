                ...
                <form class="form-inline" action="getbyparams" method="post">
                    ...
                    <span class="row">
								 <div class="form-group">
								  ...
								  <a href="${pageContext.request.contextPath }/manager/flatform/cusretire/toadd"
                    ...
                    <table id="datatable" class="table table-striped table-bordered table-hover">
                        ...
                        <c:forEach items="${pageInfo.list}" var="cusretire">
                            <tr>
                                ...
                                <th>
                                    <a onclick="del(${cusretire.saleid})" class="btn btn-danger btn-xs"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath }/manager/flatform/cusretire/getall?pn=1">首页</a>
                            </li>
                            <c:if test="${pageInfo.hasPreviousPage }">
                                <li>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/cusretire/getall?pn=${pageInfo.pageNum-1}"
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                ...
                                <c:if test="${page_Num != pageInfo.pageNum }">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/manager/flatform/cusretire/getall?pn=${page_Num }">${page_Num }</a>
                                    </li>
                                </c:if>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath }/manager/flatform/cusretire/getall?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
