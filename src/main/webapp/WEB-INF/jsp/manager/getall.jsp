                    ...
                    <table id="datatable" class="table table-striped table-bordered table-hover">
                        ...
                        <c:forEach items="${pageInfo.list}" var="type">
                            <tr>
                                ...
                                <th>${type.typename}</th>
                                <th>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/type/toupdate?protypeid=${type.protypeid}"
                                ...
                                <div class="modal-body">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-5">
                                            <input id="protypeid" name="protypeid"
                                                   class="form-control col-md-7 col-xs-5" type="number"><span id="demo1"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-5">
                                            <input id="typename" name="typename" class="form-control col-md-7 col-xs-5"
                                                   type="text" onblur="check()"><span id="demo2"
                                                                                      style="color: red;"></span>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/type/getall?pn=1">首页</a>
                                </li>
                                <c:if test="${pageInfo.hasPreviousPage }">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/manager/flatform/type/getall?pn=${pageInfo.pageNum-1}"
                                ...
                                <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                    ...
                                    <c:if test="${page_Num != pageInfo.pageNum }">
                                        <li>
                                            <a href="${pageContext.request.contextPath }/manager/flatform/type/getall?pn=${page_Num }">${page_Num }</a>
                                        </li>
                                    </c:if>
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/type/getall?pn=${pageInfo.pages}">末页</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
