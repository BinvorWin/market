        ...
        <div class="x_panel">
            ...
            <div class="row">
                <form class="form-inline" action="getbyparams" method="post">
								  ...
								  <a href="${pageContext.request.contextPath }/manager/flatform/custom/toadd"
                    ...
                    <table id="datatable" class="table table-striped table-bordered table-hover">
                        ...
                        <c:forEach items="${pageInfo.list}" var="custom">
                            <tr>
                                ...
                                <th>${custom.emali}</th>
                                <th>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/custom/toupdate?cusid=${custom.cusid}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/custom/getall?pn=1">首页</a>
                                </li>
                                <c:if test="${pageInfo.hasPreviousPage }">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/manager/flatform/custom/getall?pn=${pageInfo.pageNum-1}"
                                ...
                                <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                    ...
                                    <c:if test="${page_Num != pageInfo.pageNum }">
                                        <li>
                                            <a href="${pageContext.request.contextPath }/manager/flatform/custom/getall?pn=${page_Num }">${page_Num }</a>
                                        </li>
                                    </c:if>
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/custom/getall?pn=${pageInfo.pages}">末页</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
