                                ...
                                <th>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="${pageContext.request.contextPath }/manager/flatform/type/toupdate?protypeid=${type.protypeid}">修改</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <a href="${pageContext.request.contextPath }/manager/flatform/type/delete?protypeid=${type.protypeid}"
