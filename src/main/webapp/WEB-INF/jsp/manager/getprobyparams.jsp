...
<div class="right_col" role="main">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                        ...
                        <c:forEach items="${pageInfo.list}" var="product">
                            <tr>
                                ...
                                <th>
                                    ...
                                    <a href="${pageContext.request.contextPath }/manager/flatform/product/deletepro?proid=${product.proid}"
            ...
            <a href="${pageContext.request.contextPath }/manager/flatform/product/getlist"
