    ...
    <form class="form-horizontal form-label-left" method="post" action="update" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="saleid" name="saleid" class="form-control input-small input-sm " value="${cusretire.saleid}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="proid" name="proid" class="form-control input-small input-sm " value="${cusretire.proid}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pname" name="pname" class="form-control col-md-7 col-xs-5" value="${cusretire.pname}"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="num" name="num" class="form-control col-md-7 col-xs-5" value="${cusretire.price}" type="text"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="num" name="num" class="form-control col-md-7 col-xs-5" value="${cusretire.num}" type="text"
                       onblur="checknum()"><span id="demo4" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="num" name="num" class="form-control col-md-7 col-xs-5" value="${cusretire.total}" type="text"
                       onblur="checknum()"><span id="demo4" style="color: red;"></span>
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="indate" name="indate" class="form-control col-md-7 col-xs-5"
                       value="<fmt:formatDate pattern="yyyy-MM-dd" value="${cusretire.indate}"/>" type="date">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="retdate" name="retdate" class="form-control col-md-7 col-xs-5"
                       value="<fmt:formatDate pattern="yyyy-MM-dd" value="${cusretire.retdate}"/>" type="date">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="marks" name="marks" class="form-control col-md-7 col-xs-5" value="${cusretire.marks}"
                       type="text">
            </div>
        </div>
