    ...
    <form class="form-horizontal form-label-left" method="post" action="update" onsubmit="return checkall()">
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="managerid" name="managerid" class="form-control input-small input-sm "
                       value="${manager.managerid}" type="text" readonly="readonly">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="managername" name="managername" class="form-control col-md-7 col-xs-5"
                       value="${manager.managername}" type="text" onblur="checkname()"><span id="demo1"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="card" name="card" class="form-control col-md-7 col-xs-5" value="${manager.card}" type="text"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="tel" name="tel" class="form-control col-md-7 col-xs-5" value="${manager.tel}" type="text"
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="stafftype" name="stafftype" class="form-control col-md-7 col-xs-5"
                       value="${manager.stafftype}" type="text">
            </div>
        </div>
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="pwd" name="pwd" class="form-control col-md-7 col-xs-5" value="${ manager.pwd}"
                       type="password" placeholder="请填写密码">
            </div>
        </div>
        <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-5">密码<span>*</span>
