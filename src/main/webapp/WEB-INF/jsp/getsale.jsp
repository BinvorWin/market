    ...
    <form class="form-horizontal form-label-left" novalidate>
        ...
        <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-5">
                <input id="saleid" class="form-control input-small input-sm " value="${sale.saleid}" type="text"
                       readonly>
            </div>
        </div>
        <div class="item form-group">
        ...
        <a href="${pageContext.request.contextPath }/staff/flatform/sale/getall" class=" text-left btn btn-default  "
           role="button">返回上页</a>
        <a href="${pageContext.request.contextPath }/staff/flatform/sale/toupdate?saleid=${sale.saleid}"
